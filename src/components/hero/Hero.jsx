      ...
      <section className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 text-center mt-10 space-y-8">
        ...
        <div className="flex justify-center gap-2 flex-wrap">
          {["T", "A", "S", "K", "D", "E", "S", "K"].map((char, index) => (
            <div
              key={index}
              className="w-14 h-14 md:w-16 md:h-16 flex items-center justify-center bg-gradient-to-br from-blue-900 to-blue-700 
              text-blue-100 font-bold text-2xl rounded-lg shadow-lg transform transition-all duration-300 hover:scale-110 
              hover:from-blue-300 hover:to-blue-500 hover:text-white"
        ...
        <section className="mt-10 bg-blue-50 py-16 px-6 w-full max-w-3xl border-2 border-blue-300 border-dashed rounded-2xl shadow-lg">
          ...
          <div className="flex justify-center gap-4 flex-wrap">
            ...
            <a
              href="kaushal.kawali06@gmail.com"
              className={buttonClass}
