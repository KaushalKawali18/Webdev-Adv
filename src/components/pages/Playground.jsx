      ...
      <div className="flex flex-wrap gap-2 mb-6">
        ...
        ${
          !activeLabel && sortMode === "default"
            ...
            : "text-gray-700 border-gray-200 hover:bg-gray-50 dark:text-gray-600 dark:border-gray-700 dark:hover:bg-gray-00"
        }`}
        >
          All
        </button>
        ...
        <button
          ...
          ${
            sortMode === "stack"
              ...
              : "text-gray-700 border-gray-500 hover:bg-gray-00 dark:text-gray-600 dark:border-gray-700 dark:hover:bg-gray-00"}`}>
          Stack
        </button>
